...
public class Chirpy2Generator : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        bird = Resources.Load<GameObject>("Objects/Enemies/Chirpy (aqua)");
    ...
    void Update()
    {
        ...
        if (timeout < 0)
        {
            ...
            newBird.GetComponent<Chirpy2>().spawnedViaGenerator = true;
        }
    }
}
