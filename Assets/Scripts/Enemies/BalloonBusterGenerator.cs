...
public class BalloonBusterGenerator : MonoBehaviour
{
    private const float BASE_TIMEOUT = 8;
    ...
    void Awake()
    {
        ...
        balloon = Resources.Load<GameObject>("Objects/Enemies/Balloon Buster");
    ...
    void Update()
    {
        ...
        if (timeout < 0)
        {
            ...
            Instantiate(balloon, new Vector2(spawnX, spawnY), Quaternion.identity, transform.parent);
        }
    }
}
