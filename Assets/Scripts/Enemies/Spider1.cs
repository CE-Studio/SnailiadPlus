...
{
    private const float MOVE_TIMEOUT = 4f;
    private const float SPEED = 2.8125f;
    ...
    private void Awake()
    {
        ...
        int animData = PlayState.GetAnim("Enemy_spider_gray_data").frames[0];
        useDirectionalAnims = animData == 1;

        anim.Add("Enemy_spider_gray_normal");
        anim.Add("Enemy_spider_gray_N");
        anim.Add("Enemy_spider_gray_NE");
        anim.Add("Enemy_spider_gray_E");
        anim.Add("Enemy_spider_gray_SE");
        anim.Add("Enemy_spider_gray_S");
        anim.Add("Enemy_spider_gray_SW");
        anim.Add("Enemy_spider_gray_W");
        anim.Add("Enemy_spider_gray_NW");
        anim.Play("Enemy_spider_gray_normal");
    }
    ...
    {
        string expectedAnimName = "Enemy_spider_gray_";
