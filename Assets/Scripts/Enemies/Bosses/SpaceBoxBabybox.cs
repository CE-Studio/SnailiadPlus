...
public class SpaceBoxBabybox : Enemy
{
    ...
    private void Awake()
    {
        ...
        anim.Add("Boss_spaceBox_babybox0_hit");
        anim.Add("Boss_spaceBox_babybox1_hit");
        anim.Add("Boss_spaceBox_babybox0_turnBlue");
    ...
    public void Activate(SpaceBox parent, bool startingOrientation)
    {
        parentBoss = parent;
