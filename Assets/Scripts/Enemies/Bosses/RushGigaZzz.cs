...
public class RushGigaZzz : Enemy
{
    ...
    private void Awake()
    {
        ...
        for (int i = 0; i < PlayState.DIRS_COMPASS.Length; i++)
            anim.Add("RushBoss_gigaSnail_zzz_attack_" + PlayState.DIRS_COMPASS[i]);
        anim.Add("RushBoss_gigaSnail_zzz_spawn");
        anim.Play("RushBoss_gigaSnail_zzz_spawn");
    }
    ...
    private void ShootAtPlayer()
    {
        ...
        anim.Play("RushBoss_gigaSnail_zzz_attack_" + PlayState.VectorToCompass(accel));
    }
}
