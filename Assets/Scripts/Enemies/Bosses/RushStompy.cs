...
public class RushStompy : Boss
{
    ...
    private float bossSpeed = 1.1f;

    private StompyFoot footL;
    private StompyFoot footR;
    private RushStompyEye eyeL;
    private RushStompyEye eyeR;
    ...
    private void Awake()
    {
        ...
        if (PlayState.IsBossAlive(1))
        {
            ...
            eyeL = transform.Find("Eye L").GetComponent<RushStompyEye>();
            eyeR = transform.Find("Eye R").GetComponent<RushStompyEye>();
            InitializeParts();
            InitializeAnims();
            MoveChildren();
    ...
    private void InitializeParts()
    {
        ...
        cannons[1].transform.position = (Vector2)transform.position + new Vector2(-15f, 1.5625f);
        cannons[2].transform.position = (Vector2)transform.position + new Vector2(-12f, 1.5625f);
        cannons[3].transform.position = (Vector2)transform.position + new Vector2(-9f, 1.5625f);
        cannons[4].transform.position = (Vector2)transform.position + new Vector2(5f, 1.5625f);
        cannons[5].transform.position = (Vector2)transform.position + new Vector2(8f, 1.5625f);
        cannons[6].transform.position = (Vector2)transform.position + new Vector2(11f, 1.5625f);
        cannons[7].transform.position = (Vector2)transform.position + new Vector2(14f, 1.5625f);
    }

    private void InitializeAnims()
    {
        spriteData = PlayState.GetAnim("RushBoss_stompy_data").frames;
        ...
        for (int i = 0; i <= 2; i++)
        {
            anims[0].Add("RushBoss_stompy_footL" + i + "_ground");
            anims[0].Add("RushBoss_stompy_footL" + i + "_rise");
            anims[0].Add("RushBoss_stompy_footL" + i + "_fall");
            anims[1].Add("RushBoss_stompy_footR" + i + "_ground");
            anims[1].Add("RushBoss_stompy_footR" + i + "_rise");
            anims[1].Add("RushBoss_stompy_footR" + i + "_fall");
            anims[2].Add("RushBoss_stompy_eyeL" + i);
            anims[3].Add("RushBoss_stompy_eyeR" + i);
            anims[4].Add("RushBoss_stompy_pupilL" + i);
            anims[5].Add("RushBoss_stompy_pupilR" + i);
            anims[6].Add("RushBoss_stompy_eyelidL" + i + "_open");
            anims[6].Add("RushBoss_stompy_eyelidL" + i + "_close");
            anims[6].Add("RushBoss_stompy_eyelidL" + i + "_blink");
            anims[7].Add("RushBoss_stompy_eyelidR" + i + "_open");
            anims[7].Add("RushBoss_stompy_eyelidR" + i + "_close");
            anims[7].Add("RushBoss_stompy_eyelidR" + i + "_blink");
        }

        anims[0].Play("RushBoss_stompy_footL0_ground");
        anims[1].Play("RushBoss_stompy_footR0_ground");
        anims[2].Play("RushBoss_stompy_eyeL0");
        anims[3].Play("RushBoss_stompy_eyeR0");
        anims[4].Play("RushBoss_stompy_pupilL0");
        anims[5].Play("RushBoss_stompy_pupilR0");
        anims[6].Play("RushBoss_stompy_eyelidL0_open");
        anims[7].Play("RushBoss_stompy_eyelidR0_open");
    }
    ...
    private void PlayAnim(Parts part, bool leftSide, string mode = "")
    {
        ...
        switch (part)
        {
            default:
            case Parts.foot:
                anims[leftSide ? 0 : 1].Play("RushBoss_stompy_foot" + lOrR + attackMode + "_" + mode);
                break;
            case Parts.eye:
                anims[leftSide ? 2 : 3].Play("RushBoss_stompy_eye" + lOrR + attackMode);
                break;
            case Parts.pupil:
                anims[leftSide ? 4 : 5].Play("RushBoss_stompy_pupil" + lOrR + attackMode);
                break;
            case Parts.eyelid:
                anims[leftSide ? 6 : 7].Play("RushBoss_stompy_eyelid" + lOrR + attackMode + "_" + mode);
                break;
        }
    }
    ...
    private void MoveChildren()
    {
        ...
        if (modeMain > BossMode.intro3 && modeL == FootMode.move)
        {
            ...
            if (modeMain == BossMode.hunt)
                ...
                footLTarget.x = Mathf.Sin(thetaL / 8.7f) * 10;
        ...
        if (modeMain > BossMode.intro3 && modeR == FootMode.move)
        {
            ...
            if (modeMain == BossMode.hunt)
                ...
                footRTarget.x = Mathf.Sin(thetaR / 9.5f + Mathf.PI / 3f) * 10;
    ...
    public void Damage(int damage, bool hitLeft)
    {
        ...
        if (health < maxHealth * 0.2f && attackMode < 2)
        {
            bossSpeed = 1.4f;
            attackMode = 2;
            UpdateAnimLifeState();
