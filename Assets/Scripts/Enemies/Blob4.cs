...
public class Blob4 : Enemy
{
    ...
    private readonly Vector2 jumpVelocity = new Vector2(6.25f, 12.5f);
    ...
    private void Awake()
    {
        ...
        Spawn(1800, 8, 30, true, 8);
        col.TryGetComponent(out box);

        anim.Add("Enemy_blob4_normal");
        anim.Add("Enemy_blob4_jump");
        anim.Add("Enemy_blob4_quiver");
        anim.Play("Enemy_blob4_normal");
