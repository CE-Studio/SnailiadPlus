...
public class Fireball2 : Enemy
{
    ...
    public bool rotation; // Assuming the iceball is tracking the inner edge of a ring, false for clockwise and true for counter-clockwise
    ...
    private void Awake()
    {
        ...
        updateAnimOnTurn = PlayState.GetAnim("Enemy_fireball2_data").frames[0] == 1;
    }
