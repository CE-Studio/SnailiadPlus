...
public class Upside : Player
{
    ...
    public override void OnEnable()
    {
        ...
        defaultGravityDir = Dirs.Ceiling;
        ...
        int[] tempData = PlayState.GetAnim("Player_Upside_data").frames;
        ...
        for (int i = 0; i <= 3; i++)
        {
            for (int j = 0; j < animDirections.Length; j++)
            {
                ...
                {
                    anim.Add("Player_Upside" + i + "_" + animDirections[j] + "_" + animStates[k]);
                }
            }
            anim.Add("Player_Upside" + i + "_die");
        }
    ...
    public override void LateUpdate()
    {
         ...
         * 8 - Flip Y on ceiling 
        \*/
        string currentState = "Player_Upside" + PlayState.globalFunctions.shellStateBuffer + "_";
        if (inDeathCutscene)
        {
