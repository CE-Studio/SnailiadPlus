...
func _on_save_spawn_pressed(_value) -> void:
	match pro_id:
		1: Statics.current_profile = Statics.data_profile1.duplicate(true)
		2: Statics.current_profile = Statics.data_profile2.duplicate(true)
		3: Statics.current_profile = Statics.data_profile3.duplicate(true)
