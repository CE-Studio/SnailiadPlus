...
func _get_name(key:String) -> StringName:
	match key:
		...
		"angryblock": return tr(&"Angry block")
...
func _get_desc(key:String) -> StringName:
	match key:
		...
		"blobAngel": return tr(&"Habitat: L.Lirata\nPalette: shining\nEnergy: overflowing\n\nThanks to high altitudes, sun exposure, proximity to holy figures, or any combination of the three, some blobs can become imbued with the attributes of light and sky.  They're not entirely sure what to do with these powers.")
		...
		"angryblock": return tr(&"Habitat: S.Silere\nBody: crazy tough\nMind: at peace\n\nLife as a block is a simple one.  You can't move much, and if no one's around you can't really occupy yourself with anything.  This one, however, seems to live contently, in spite of the expression it wears.  When alone, it likes to hum to itself.")
		...
		"pincerCeiling": return tr(&"Habitat: L.Lirata\nDifferences: hardly any\nGravity: what's that?\n\nAn odd thing about the Pincer is its strange knack for defying gravity, in spite of the clear lack of turtle lineage.  They won't tell us how they do it.")
